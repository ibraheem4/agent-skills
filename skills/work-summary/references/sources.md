...
Pass A only shows what he pushed out — without pass B, a question a teammate asked him in
...
and `Acme` sessions never appear — the scope rule holds without extra filtering.
